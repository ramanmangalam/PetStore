...
STATICS_DIRS=os.path.join(BASE_DIR1,"statics")
...
SECRET_KEY = 'django-insecure-xf+09pl#0d2b-ze2or17&6bl&+io5_-up$6r3f2n&5+k@x#)s!'
...
EMAIL_HOST_USER='ms4raman@gmail.com'
EMAIL_HOST_PASSWORD='dkvv npiv ssuw trux'
EMAIL_PORT=587
EMAIL_USE_TLS=True
